          ...
          for szk in data_polgi[1][d]['szavazokorok']:
            ...
            for column in columns:
              ...
              if column not in ossz:
                ossz[column] = 0
              ossz[column] += int(data_polgi[0][str(szk)][column])
              col_no += 1
            if data_polgi[2] != {}:
              ...
              for kepv_column in kepv_columns:
                ...
                if kepv_column not in ossz:
                  ossz[kepv_column] = 0
                ossz[kepv_column] += int(data_polgi[2][str(szk)][kepv_column])
                col_no += 1
            row_no += 1
            if data_polgi[2] != {}:
              col_no = polgi_list_len + 1
              ...
              for kepv_column in kepv_columns:
                worksheet_onk.write(row_no, col_no, ossz[kepv_column])
                col_no += 1
          col_no = 1         
          worksheet_onk.write(row_no, 0, "Összesen")           
          for column in columns:
             worksheet_onk.write(row_no, col_no, ossz[column])
             col_no += 1
          row_no += 2
